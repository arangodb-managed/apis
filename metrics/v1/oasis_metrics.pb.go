...
func (*Token) Descriptor() ([]byte, []int) {
	return fileDescriptor_7703596ef5fb695d, []int{0}
}
...
func (*TokenList) Descriptor() ([]byte, []int) {
	return fileDescriptor_7703596ef5fb695d, []int{1}
}
...
func (*ListTokensRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7703596ef5fb695d, []int{2}
}
...
func (*GetMetricsEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7703596ef5fb695d, []int{3}
}
...
func (*MetricsEndpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_7703596ef5fb695d, []int{4}
}
...
func init() { proto.RegisterFile("oasis_metrics.proto", fileDescriptor_7703596ef5fb695d) }

var fileDescriptor_7703596ef5fb695d = []byte{
	// 865 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Token) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Token) > 0 {
		i -= len(m.Token)
		copy(dAtA[i:], m.Token)
		i = encodeVarintOasisMetrics(dAtA, i, uint64(len(m.Token)))
		i--
		dAtA[i] = 0x52
	}
	if m.ExpiresAt != nil {
		{
			...
			i -= size
			i = encodeVarintOasisMetrics(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x4a
	}
	...
	if len(m.DeploymentId) > 0 {
		...
		i = encodeVarintOasisMetrics(dAtA, i, uint64(len(m.DeploymentId)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Description) > 0 {
		...
		i = encodeVarintOasisMetrics(dAtA, i, uint64(len(m.Description)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintOasisMetrics(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Url) > 0 {
		i -= len(m.Url)
		copy(dAtA[i:], m.Url)
		i = encodeVarintOasisMetrics(dAtA, i, uint64(len(m.Url)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Id) > 0 {
		i -= len(m.Id)
		copy(dAtA[i:], m.Id)
		i = encodeVarintOasisMetrics(dAtA, i, uint64(len(m.Id)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *MetricsEndpoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Endpoint) > 0 {
		...
		i = encodeVarintOasisMetrics(dAtA, i, uint64(len(m.Endpoint)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintOasisMetrics(dAtA []byte, offset int, v uint64) int {
	offset -= sovOasisMetrics(v)
	base := offset
	for v >= 1<<7 {
...
func (m *Token) Size() (n int) {
	...
	l = len(m.Id)
	if l > 0 {
		n += 1 + l + sovOasisMetrics(uint64(l))
	}
	l = len(m.Url)
	if l > 0 {
		n += 1 + l + sovOasisMetrics(uint64(l))
...
func sovOasisMetrics(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozOasisMetrics(x uint64) (n int) {
	return sovOasisMetrics(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Token) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowOasisMetrics
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthOasisMetrics
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipOasisMetrics(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipOasisMetrics(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowOasisMetrics
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthOasisMetrics
			}
			iNdEx += length
			if iNdEx < 0 {
				return 0, ErrInvalidLengthOasisMetrics
		...
		case 3:
			for {
				...
				next, err := skipOasisMetrics(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthOasisMetrics = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowOasisMetrics   = fmt.Errorf("proto: integer overflow")
)
