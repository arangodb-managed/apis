...
const (
	UsageService_GetAPIVersion_FullMethodName  = "/arangodb.cloud.usage.v1.UsageService/GetAPIVersion"
	UsageService_ListUsageItems_FullMethodName = "/arangodb.cloud.usage.v1.UsageService/ListUsageItems"
)
...
func (c *usageServiceClient) GetAPIVersion(ctx context.Context, in *v1.Empty, opts ...grpc.CallOption) (*v1.Version, error) {
	...
	out := new(v1.Version)
	err := c.cc.Invoke(ctx, UsageService_GetAPIVersion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usageServiceClient) ListUsageItems(ctx context.Context, in *ListUsageItemsRequest, opts ...grpc.CallOption) (*UsageItemList, error) {
	...
	err := c.cc.Invoke(ctx, UsageService_ListUsageItems_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UsageService_GetAPIVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UsageService_GetAPIVersion_FullMethodName,
	}
...
func _UsageService_ListUsageItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UsageService_ListUsageItems_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
